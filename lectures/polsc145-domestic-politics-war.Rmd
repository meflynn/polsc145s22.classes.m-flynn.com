...
```{r, out.width="40%", fig.cap="Headline from the New York Times discussing Clinton impeachment scandal alongside attacks on suspected terrorist sites."}
knitr::include_graphics("../../../media/clinton-impeachment-headline.PNG", error = FALSE)
```
...
```{r, out.width="40%"}
knitr::include_graphics("../../../media/Worpol3_Art_JPEG/ch04/WORPOL3_FIGUN04.p153a.jpg", error = FALSE)
```
...
```{r, out.width="40%"}
knitr::include_graphics("../../../media/Worpol3_Art_JPEG/ch04/WORPOL3_FIGUN04.p153b.jpg", error = FALSE)
```
...
knitr::include_graphics("https://static.wikia.nocookie.net/totalwar-ar/images/0/09/Jacobo_Arbenz_Guzman.jpg/revision/latest?cb=20160415194535")
```
]
