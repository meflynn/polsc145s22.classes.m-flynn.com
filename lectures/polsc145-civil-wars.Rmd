...
```{r, fig.cap="Sudan and South Sudan."}

knitr::include_graphics("../../../media/South Sudan Oil Fields.gif", error = FALSE)
```
...
.pull-right[
```{r, out.width="100%", fig.cap="A US soldier stands in a field of poppies in Afghanistan."}
knitr::include_graphics("../../../media/Poppies.jpg", error = FALSE)
```
]
...
.pull-right[
```{r, out.width="100%"}
knitr::include_graphics("../../../media/West Side Boys.jpg", error = FALSE)
```
]
...
```{r Kim Phuc Photograph, out.width="80%", fig.cap="South Vietnamese forces follow after terrified children, including 90year-old Kim Phuc, center, as they run down Route 1 near Trang Bang after an aerial attack on suspected Vietcong hiding places on June 8, 1972. Photo taken by Associated Press photographer Nick Ut. South Vietnamese military dropped napalm on a village, mistaking fleeing civilians for insurgents."}
knitr::include_graphics("../../../media/Napalm Girl Vietnam.jpg", error = FALSE)
```