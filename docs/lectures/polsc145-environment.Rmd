...
knitr::include_graphics("aqi-snapshot.png", error = FALSE)
...
ggplot(d1 , aes(x = x, xend = xend, y = y, yend = yend)) +
  geom_dag_point(aes(color = name), show.legend = FALSE, size = 20) +
  geom_dag_edges() +  
  geom_dag_label_repel(aes(label = name), color = "black", size = 10, segment.size = 2, box.padding = 2, point.padding = 2, nudge_y = 10) +
  theme_dag() +
