...
```{r, out.width="40%"}
knitr::include_graphics("../../../media/Worpol3_Art_JPEG/ch03/WORPOL3_FIGUN03.p99.jpg", error = FALSE)
...
```{r, out.width="40%"}
knitr::include_graphics("../../../media/Worpol3_Art_JPEG/ch03/WORPOL3_FIGUN03.p98.jpg", error = FALSE)
...
knitr::include_graphics("../../../media/George-W-Bush.jpeg", error = FALSE)
```
]

.pull-right[
```{r saddam-hussein, fig.height=6, fig.width=4, fig.cap="Saddam Hussein", fig.align='center'}
knitr::include_graphics("../../../media/saddam-hussein.jpg", error = FALSE)
```
]
]
