...
```{r, out.width="40%"}
knitr::include_graphics(here("../../media/Worpol3_Art_JPEG/ch03/WORPOL3_FIGUN03.p99.jpg"), error = FALSE)
...
```{r, out.width="40%"}
knitr::include_graphics(here("../../media/Worpol3_Art_JPEG/ch03/WORPOL3_FIGUN03.p98.jpg"), error = FALSE)
```
