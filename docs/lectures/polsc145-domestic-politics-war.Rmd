...
knitr::include_graphics("lectures/lecture-media/clinton-impeachment-headline.PNG", error = FALSE)
```
...
```{r, out.width="40%"}
knitr::include_graphics("lectures/lecture-media/Worpol3_Art_JPEG/ch04/WORPOL3_FIGUN04.p153a.jpg", error = FALSE)
```
...
```{r, out.width="40%"}
knitr::include_graphics("lectures/lecture-media/Worpol3_Art_JPEG/ch04/WORPOL3_FIGUN04.p153b.jpg", error = FALSE)
```
